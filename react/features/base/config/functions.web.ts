...
export function _setDeeplinkingDefaults(deeplinking: IDeeplinkingConfig) {
    ...
    desktop.appName = desktop.appName || 'Exentriq Meet';

    ios.appName = ios.appName || 'Exentriq Meet';
    ios.appScheme = ios.appScheme || 'com.exentriq.meet';
    ios.downloadLink = ios.downloadLink
        || 'https://itunes.apple.com/us/app/jitsi-meet/id1165103905';
    if (ios.dynamicLink) {
        ios.dynamicLink.apn = ios.dynamicLink.apn || 'com.exentriq.meet';
    ...
    android.appName = android.appName || 'Exentriq Meet';
    android.appScheme = android.appScheme || 'com.exentriq.meet';
    android.downloadLink = android.downloadLink
        || 'https://play.google.com/store/apps/details?id=org.jitsi.meet';
    android.appPackage = android.appPackage || 'com.exentriq.meet';
